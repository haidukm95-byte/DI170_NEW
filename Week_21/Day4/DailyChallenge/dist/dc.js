...
class Library {
    books = [];
    addBook(title, author, isbn, publishedYear, genre = '') {
...
const book1 = { title: "1984", author: "George Orwell", isbn: "001", publishedYear: 1949, genre: "Dystopian" };
const book2 = { title: "Dune", author: "Frank Herbert", isbn: "002", publishedYear: 1965 }; // genre is optional
const book3 = { title: "Neuromancer", author: "William Gibson", isbn: "003", publishedYear: 1984, genre: "Cyberpunk" };
