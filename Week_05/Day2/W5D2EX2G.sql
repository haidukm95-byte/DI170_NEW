...
SELECT first_name, last_name, birth_date FROM students ORDER BY last_name ASC FETCH FIRST 4 ROWS ONLY;
SELECT first_name, last_name, birth_date FROM students WHERE birth_date = (SELECT MAX(birth_date) FROM students);
SELECT first_name, last_name, birth_date FROM students ORDER BY last_name ASC OFFSET 2 ROWS FETCH NEXT 3 ROWS ONLY 